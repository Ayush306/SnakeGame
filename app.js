...
function createSquare(x,y){
    gameAreaContext.fillStyle="#00000"
    gameAreaContext.fillReact(x* cellWidth ,y*cellWidth,cellWidth)
}
function changeDirection(e){
    var keys = e.which;
         if(keys == "40" && snakeDirection !="up" ) snakeDirection="down"
    else if(keys == "39" && snakeDirection !="left" ) snakeDirection="rigth"
    else if(keys == "38" && snakeDirection !="down" ) snakeDirection="up"
    else if(keys == "37" && snakeDirection !="rigth" ) snakeDirection="left"
}
